...
// let configure = {
//   user: 'sqlfamily', // better stored in an app setting such as process.env.DB_USER
//   password: 'sqlf@m1ly', // better stored in an app setting such as process.env.DB_PASSWORD
//   server: 'sqlservercentralpublic.database.windows.net', // better stored in an app setting such as process.env.DB_SERVER
//   port: 1433, // optional, defaults to 1433, better stored in an app setting such as process.env.DB_PORT
//   database: 'AdventureWorks', // better stored in an app setting such as process.env.DB_NAME
//   authentication: {
//       type: 'default'
//   },
//   options: {
...
exports.config = {
  ...
  beforeSession: async function () {
    ...
    global.poolConnection = await sql.connect(databaseConfig);
  },
  /**
